...
<script>
        document.addEventListener('DOMContentLoaded', function () {
            // Check if show_success_modal is set in session
            @if (session('show_success_modal'))
                ...
                successModalBtn.addEventListener('click', function () {
                    ...
                    @if (session('show_login'))
                        // Assuming you have a function or logic to show the login form
                        document.getElementById('welcomeForm').classList.remove('active');
