                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th data-label="Usuarios Asignados">Usuarios Asignados</th>
                            <th data-label="Permisos">Permisos</th>
                            <th data-label="Creado">Creado</th>
                    ...
                    <tbody>
                        @foreach ($roles as $role)
                            <tr>
                                ...
                                <td data-label="Nombre" class="product-name-cell">
                                    <div>
                                        <div class="product-name">{{ $role->name }}</div>
                                        <div class="product-id">{{ $role->guard_name }}</div>
                                    </div>
                                </td>
                                <td data-label="Usuarios Asignados">
                                ...
                                <td data-label="Acciones">
                                    <div class="action-buttons">
                                        ...
                                        <button class="btn-action edit-btn" data-id="{{ $role->id }}"
                                            data-name="{{ $role->name }}"
                                            data-permissions="{{ $role->permissions->pluck('name') }}">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button class="btn-action delete-btn" data-id="{{ $role->id }}"
                                            data-name="{{ $role->name }}"
            ...
            <form id="deleteRoleForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div id="users_warning" class="alert alert-warning" style="display: none;">
                        ...
                        Este rol tiene usuarios asignados. La eliminación no será posible mientras existan usuarios con este
                        rol.
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.edit-btn').forEach(function(btn) {
                btn.addEventListener('click', function() {
                    ...
                    document.querySelectorAll('#edit_permissions_container input[type="checkbox"]')
                    ...
                    permissionsList.forEach(function(permissionName) {
                        const checkbox = document.querySelector(
                            `#edit_permissions_container input[value="${permissionName}"]`
                        );
                        if (checkbox) {
