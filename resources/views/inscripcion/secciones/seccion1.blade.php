    ...
    $(document).ready(function() {
        ...
        function updateFieldUI(field, showError = false) {
            ...
            if (!interactedFields.has(fieldName) && !showError) {
                ...
                group.removeClass('has-error invalid valid');
                field.removeClass('invalid valid');
        ...
        const observer = new MutationObserver(function() {
            interactedFields.add('actividades_seleccionadas'); // Mark as interacted
        ...
        function toggleObjetoSocial() {
            if (tipoPersonaSelect.length && objetoSocialGroup.length) {
                ...
                if (interactedFields.has('objeto_social')) {
        ...
        if (preSelectedActivities) {
            try {
                ...
                updateActivityDisplay();
                // Note: Pre-selected activities won't update dropdown until sector is selected
            } catch (e) {
